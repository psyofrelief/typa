...
const About = () => {
  ...
  return (
    <div id="page--about">
      ...
      <section className="section-test-info">
        <h2 className="section-heading">What does this typing test involve?</h2>
...
`}</p>
      ...
      <section className="section-test-info">
        <h2 className="section-heading">What is a good typing test score?</h2>
      ...
      <section className="section-test-info">
        <h2 className="section-heading">{`How can I improve my typing skills?`}</h2>
      ...
      <section className="section-start-test">
        <Link href="/test">Click here to begin typing test</Link>
      </section>
    </div>
  );
};
